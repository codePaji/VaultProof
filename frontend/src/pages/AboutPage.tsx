      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-secondary text-sm">
            How VaultProof leverages Zero-Knowledge cryptography and Compact smart contracts on Midnight.
          </p>
        </motion.div>
            ...
            <table className="w-full text-left text-xs font-sans">
              <thead>
                <tr className="border-b border-white/10 text-muted uppercase font-mono">
                  ...
                  <th className="pb-3 text-accent">VaultProof (Midnight)</th>
                </tr>
              </thead>
        ...
        <div className="glass-card p-6 rounded-2xl mb-lg">
          ...
          <div className="p-4 bg-black/50 rounded-xl border border-white/5 font-mono text-xs text-accent mb-md overflow-x-auto">
            ...
            <div className="pl-4">return persistentHash([pad(32, "vaultproof:voter:v1"), sk]);</div>
            <div>&#125;</div>
            <br />
          ...
          <p className="text-secondary text-xs leading-relaxed">
            By proving that the nullifier corresponds to a valid secret without ever disclosing that secret, VaultProof prevents sybil replay attacks while preserving complete voter anonymity.
          </p>
        </div>
        ...
        <div className="glass-card p-6 rounded-2xl mb-lg">
          ...
          <p className="text-secondary text-xs leading-relaxed mb-md">
            VaultProof underwent a rigorous security audit covering domain separation, collision resistance, low-entropy secret guardrails, and transaction transcript analysis.
          </p>
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/codePaji/VaultProof/blob/main/AUDIT.md"
              target="_blank"
              rel="noreferrer"
