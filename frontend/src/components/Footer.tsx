    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div>
          ...
          <p className="text-secondary text-sm mb-lg max-w-sm">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm text-secondary">
            <li><Link to="/vote" className="hover:text-accent">Anonymous Voting</Link></li>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm text-secondary">
            ...
            <li>
              <a 
                href="https://github.com/codePaji/VaultProof" 
                target="_blank" 
                rel="noreferrer"
                className="hover:text-accent inline-flex items-center gap-1"
              >
      ...
      <div className="footer-bottom">
        <div>
          © {currentYear} VaultProof Protocol. Open source under Apache-2.0. Built for Midnight Network.
        </div>
