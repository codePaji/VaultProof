...
describe('VaultProof Smart Contract Logic & Cryptographic Verification', () => {
  ...
  //   persistentHash<Vector<2, Bytes<32>>>([pad(32, "vaultproof:voter:v1"), sk])
  function deriveVoterNullifier(sk: Uint8Array): Uint8Array {
    const prefix = pad32('vaultproof:voter:v1');
